...
//
//	pFile = fopen( "filename", "rb" ); // binary 
//
//	if ( pFile != NULL )
//	{
//		MD2FILEHEADER md2Header;
//		
//		// md2 header
//		fread( &md2Header, sizeof( MD2FILEHEADER ), 1, pFile );
//		
...
//		num_frames = md2Header.num_frames;
//		num_xyz = md2Header.num_xyz;
//		num_glcmds = md2Header.num_glcmds;
//
//		m_vertices = new vec3_t[ num_xyz * num_frames ];
//		m_glcmds = new int[ num_glcmds ];
//		m_lightnormals = new int[ num_xyz * num_frames ];
//		buffer = new char[ num_frames * md2Header.framesize ];
//
//		/////////////////////////////////////////////
//		//          reading file data
//		fseek( pFile, md2Header.ofs_frames, SEEK_SET );
//		fread( buffer, md2Header.num_frames, md2Header.framesize, pFile );
//
//		fseek( pFile, md2Header.ofs_glcmds, SEEK_SET );
//		fread( m_glcmds, md2Header.num_glcmds, sizeof( int ), pFile );
//
//		/////////////////////////////////////////////
//
...
//		{
//			// ajust pointers
//			frame = (frame_t *)&buffer[ md2Header.framesize * j ];
...
//
//	}else{
//	/*	MessageBox(NULL,"¼ÓÔØ MD2 ÎÄ¼þÊ§°Ü ","´íÎó",MB_OK);*/
//		return false;
//	}
//	return true;
//
